...
class MainViewController: UIViewController {
	...
	func showSettingAlert() {
		let alert = UIAlertController(title: "Please Change Network Settings", message: "So that this app will be able to discover and connect to divices on the networks you use.", preferredStyle: .alert)
		
		let settingAction = UIAlertAction(title: "Setting", style: .default, handler: { (UIAlertAction) in
